...
const UploadProduct = () => {
  ...
  const validateForm = () => {
    ...
    if (data.image.length === 0) newErrors.image = "At least one image is required";
    if (data.category.length === 0) newErrors.category = "At least one category is required";
  ...
  const handleSubCategorySelect = (e) => {
    ...
    if (!selectedSub || data.subCategory.find((c) => c._id === value)) {
      setErrors({ ...errors, subCategory: "Subcategory already added or invalid" });
      return;
    }
    ...
    <section className="w-full p-4 max-w-6xl mx-auto">
      ...
      <div className="bg-white p-6 rounded-lg shadow">
        <form className="grid gap-6" onSubmit={handleSubmit}>
          ...
          <div className="border-b pb-4">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="grid gap-2">
                ...
                <input
                  ...
                  className={`bg-gray-50 p-2 outline-none border rounded ${errors.name ? "border-red-500" : "focus:border-yellow-400"}`}
                />
              ...
              <div className="grid gap-2">
                ...
                <input
                  ...
                  value={data.unit}
                  onChange={handleChange}
                  className={`bg-gray-50 p-2 outline-none border rounded ${errors.unit ? "border-red-500" : "focus:border-yellow-400"}`}
                />
            ...
            <div className="mt-4 grid gap-2">
              ...
              <textarea
                ...
                onChange={handleChange}
                rows={4}
                className={`bg-gray-50 p-2 outline-none border rounded ${errors.description ? "border-red-500" : "focus:border-yellow-400"}`}
              />
            ...
            <div className="grid gap-4">
              <div>
                ...
                <label
                  ...
                  className={`block mt-2 bg-gray-50 h-32  justify-center items-center cursor-pointer border-2 border-dashed rounded-lg ${errors.image ? "border-red-500" : "border-gray-300 hover:border-yellow-400"}`}
                >
                ...
                {data.image.length > 0 && (
                  <p className="text-sm text-gray-500 mt-1">{data.image.length} image(s) uploaded</p>
                )}
              </div>
              ...
              <div className="grid gap-2">
                ...
                <div className="flex gap-2">
                  <select
                    ...
                    className={`bg-gray-50 border w-full p-2 rounded ${errors.category ? "border-red-500" : "focus:border-yellow-400"}`}
                  >
              ...
              <div className="grid gap-2">
                ...
                <div className="flex gap-2">
                  <select
                    ...
                    className={`bg-gray-50 border w-full p-2 rounded ${errors.subCategory ? "border-red-500" : "focus:border-yellow-400"}`}
                  >
          ...
          <div className="border-b pb-4">
            <h3 className="text-lg font-semibold mb-4 text-gray-700">Pricing & Stock</h3>
            <div className="grid md:grid-cols-3 gap-4">
              <div className="grid gap-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    min="0"
                    step="0.01"
                    className={`bg-gray-50 p-2 pl-8 outline-none border rounded w-full ${errors.price ? "border-red-500" : "focus:border-yellow-400"}`}
                  />
                </div>
              ...
              <div className="grid gap-2">
                <label className="font-medium text-gray-700" htmlFor="discount">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    min="0"
                    max="100"
                    className={`bg-gray-50 p-2 pr-8 outline-none border rounded w-full ${errors.discount ? "border-red-500" : "focus:border-yellow-400"}`}
                  />
                </div>
              ...
              <div className="grid gap-2">
                ...
                <input
                  ...
                  onChange={handleChange}
                  min="0"
                  className={`bg-gray-50 p-2 outline-none border rounded ${errors.stock ? "border-red-500" : "focus:border-yellow-400"}`}
                />
            ...
            <div className="grid gap-4">
              {Object.keys(data.more_details).map((fieldName) => (
                <div key={fieldName} className="grid gap-2 relative">
                  <label className="font-medium text-gray-700 capitalize">{fieldName}</label>
                  <div className="flex gap-2">
                    <input
                      type="text"
